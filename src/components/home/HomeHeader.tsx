  ...
  return (
    <div suppressHydrationWarning className="-mx-8 -mt-8 px-4 sm:px-8 pt-16 sm:pt-24 pb-16 sm:pb-20 bg-gradient-to-br from-green-900/50 via-black to-black relative overflow-hidden border-b border-white/5">
      ...
      <div suppressHydrationWarning className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-green-500/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute -bottom-20 -left-40 w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[120px] animate-pulse delay-700" />
        <div className="absolute top-1/4 left-1/3 w-[400px] h-[400px] bg-blue-500/5 rounded-full blur-[100px]" />
      </div>
